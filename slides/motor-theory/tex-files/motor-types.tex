...
\begin{column}{0.4\textwidth}  %%<--- here
	...
	\vspace{-3mm}
   	\begin{figure}
   		\includegraphicscopyright[width=0.9\linewidth]{motor-types/pdf/brushed-motor}{}
 	\end{figure}
...
\begin{column}{0.4\textwidth}  %%<--- here
	...
	\vspace{-3mm}
   	\begin{figure}
   		\includegraphicscopyright[width=0.9\linewidth]{motor-types/pdf/dc-geat-motor}{}
 	\end{figure}
...
\begin{column}{0.4\textwidth}  %%<--- here
	...
	\vspace{-3mm}
   	\begin{figure}
   		\includegraphicscopyright[width=0.9\linewidth]{motor-types/pdf/brushless-motor}{}
 	\end{figure}
...
\begin{column}{0.4\textwidth}  %%<--- here
	...
	\vspace{-3mm}
   	\begin{figure}
   		\includegraphicscopyright[width=0.9\linewidth]{motor-types/pdf/servo-motor}{}
 	\end{figure}
...
\begin{column}{0.4\textwidth}  %%<--- here
	...
	\vspace{-3mm}
   	\begin{figure}
   		\includegraphicscopyright[width=0.9\linewidth]{motor-types/pdf/stepper-motor}{}
 	\end{figure}
